...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(609, 60);
			...
			this->label2->Location = System::Drawing::Point(0, 101);
			...
			// tbEmail
			// 
			this->tbEmail->Location = System::Drawing::Point(149, 98);
			this->tbEmail->Name = L"tbEmail";
			this->tbEmail->Size = System::Drawing::Size(424, 38);
			this->tbEmail->TabIndex = 2;
			// 
			// Password
			// 
			this->Password->AutoSize = true;
			this->Password->Location = System::Drawing::Point(-6, 165);
			...
			// tbPassword
			// 
			this->tbPassword->Location = System::Drawing::Point(149, 165);
			this->tbPassword->Name = L"tbPassword";
			this->tbPassword->PasswordChar = '*';
			this->tbPassword->Size = System::Drawing::Size(424, 38);
			this->tbPassword->TabIndex = 4;
			// 
			// btnOK
			// 
			this->btnOK->Location = System::Drawing::Point(217, 261);
			this->btnOK->Name = L"btnOK";
			this->btnOK->Size = System::Drawing::Size(180, 38);
			...
			// btnCancel
			// 
			this->btnCancel->Location = System::Drawing::Point(421, 261);
			this->btnCancel->Name = L"btnCancel";
			this->btnCancel->Size = System::Drawing::Size(152, 38);
			...
			this->llRegister->Location = System::Drawing::Point(453, 308);
			...
			this->ClientSize = System::Drawing::Size(630, 349);
...
private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	try {
		...
		MessageBox::Show("Failed to connect to database because of " + e->Message, "Database connection Error", MessageBoxButtons::OK);
	}
}
